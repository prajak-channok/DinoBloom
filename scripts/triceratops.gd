extends Node2D
class_name Triceratops

## M4: see Dryosaurus.died / Dryosaurus.reached_boundary for contract.
signal died
signal reached_boundary

const DATA: DinosaurData = preload("res://data/dinosaurs/triceratops.tres")

## Runtime footprint used for the stop point at the right edge of a Plant cell.
## Triceratops is a Tank, given a larger footprint than Dryosaurus/Velociraptor.
@export var body_half_width: float = 64.0
